/** @file
  ...
  The definition block in ACPI table for CX20721 device under I2C6 Controller

  Initially based on AudioSsdtUpdate\RT5677.aml
  ...
  )
{
  ...
  Scope (\_SB.I2C6) {
            Device (CNXT)
            {
                ...
                Name (_HID, "14F10720" /* Conexant I2S Audio Codec */)  // _HID: Hardware ID
                Name (_CID, "14F10720" /* Conexant I2S Audio Codec */)  // _CID: Compatible ID
                Name (_DDN, "Conexant Codec Controller")  // _DDN: DOS Device Name
                Name (_UID, One)  // _UID: Unique ID
                // FIXME: is this needed Name (_S0W, 0X03)  // _S0W: S0 Device Wake up
                Method (_CRS, 0, Serialized)  // _CRS: Current Resource Settings
                {
                    Name (SBUF, ResourceTemplate ()
                    {
                        I2cSerialBus (0x0033, //device address 33h
                            ControllerInitiated,
                            0x00061A80, // Speed : 400Khz
                            AddressingMode7Bit, // 7bits address
                            "\\_SB.I2C6", //I2C 6 bus
                    ...
                    Return (SBUF) /* \_SB_.I2C6.CNXT._CRS.SBUF */
                }
