/** @file
  The definition block in ACPI table for WM8731 device under I2C6 Controller
  ...
  )
{
  ...
  Scope (\_SB.I2C6) {
            Device (WLFC)
            {
                ...
                Name (_HID, "1AEC8731" /* Wolfson WM8731 I2S Audio Codec */)  // _HID: Hardware ID
                Name (_CID, "1AEC8731" /* Wolfson WM8731 I2S Audio Codec */)  // _CID: Compatible ID
                Name (_DDN, "TI WM8731 Codec Controller ")  // _DDN: DOS Device Name
                ...
                Method (_CRS, 0, Serialized)  // _CRS: Current Resource Settings
                {
                    ...
                    Return (SBUF) /* \_SB_.I2C6.WLFC._CRS.SBUF */
                }
