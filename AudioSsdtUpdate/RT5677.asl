/** @file
  The definition block in ACPI table for RT5677 device under I2C6 Controller
  ...
  )
{
  ...
  Scope (\_SB.I2C6) {
            Device (RTKX)
            {
                ...
                Name (_HID, "10EC5677" /* Realtek I2S Audio Codec */)  // _HID: Hardware ID
                Name (_CID, "10EC5677" /* Realtek I2S Audio Codec */)  // _CID: Compatible ID
