/** @file
  The definition block in ACPI table for DA7212 device under I2C6 Controller
  ...
  )
{
  ...
  Scope (\_SB.I2C6) {
            Device (DLGS)
            {
                ...
                Name (_HID, "DLGS7212" /* Dialog 7212 I2S Audio Codec */)  // _HID: Hardware ID
                Name (_CID, "DLGS7212" /* Dialog 7212 I2S Audio Codec */)  // _CID: Compatible ID
                Name (_DDN, "Dialog 7212 Codec Controller ")  // _DDN: DOS Device Name
                ...
                Method (_CRS, 0, Serialized)  // _CRS: Current Resource Settings
                {
                    ...
                    Return (SBUF) /* \_SB_.I2C6.DLGS._CRS.SBUF */
                }
